    ...
    function Block () {
        ...
        */
        this.createFrameCover = function() {
            ...
            delButton.setAttribute('class', 'btn btn-danger btn-sm deleteBlock');
            delButton.setAttribute('type', 'button');
            delButton.innerHTML = '<i class="fui-trash"></i> <span>Remove</span>';
            delButton.addEventListener('click', this, false);
                    
            var resetButton = document.createElement('BUTTON');
            resetButton.setAttribute('class', 'btn btn-warning btn-sm resetBlock');
            ...
            dragButton.setAttribute('class', 'btn btn-default btn-sm dragBlock');
